...
import testingoperative.asor.domain.service.ProductService;
...
public class ProductController {
    ...
    @GetMapping("/{id}")
    @ApiOperation("search a product and its information with a productId")
    @ApiResponses({
            @ApiResponse(code = 200, message = "OK"),
            @ApiResponse(code = 404, message = "product not found")
    })
    public ResponseEntity<Product> getProduct(@ApiParam(value = "the id of the product", required = true, example = "4")
